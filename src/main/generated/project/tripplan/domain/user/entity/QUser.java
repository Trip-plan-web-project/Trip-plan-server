...
public class QUser extends EntityPathBase<User> {
    ...
    private static final long serialVersionUID = -845041550L;
    ...
    public final EnumPath<project.tripplan.domain.user.enums.UserRole> userRole = createEnum("userRole", project.tripplan.domain.user.enums.UserRole.class);

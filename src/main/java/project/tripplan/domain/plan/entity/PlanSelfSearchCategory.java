...
@Entity
@Builder
public class PlanSelfSearchCategory extends BaseEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "plan_self_search_category_id")
    private Long id;
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "self_search_category_id")
    private SelfSearchCategory selfSearchCategory;
}
